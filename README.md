...
- **Manual file/folder management** — On the Update Your Project page, use **New File** / **New Folder** to add items anywhere in the tree, and the ✕ button on any tree item to delete a file or an entire folder (with confirmation). Changes are written straight to disk automatically if a project folder is linked
