/* ---------------------------------------------------------------------
 * todo_project.js
 * Page-specific behavior for todo_project.html (Update Your Project —
 * To-Do Plan). Shared workspace/editor/plan/Ask-AI logic lives in
 * app.js — this file only adds small conveniences specific to this page
 * (folder-load support detection and the help popup), same pattern as
 * update_project.js.
 * ------------------------------------------------------------------- */
